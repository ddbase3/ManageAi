...
class AdministrationSystemConfigurationContentControl extends AbstractContentControl {
	...
	public static function getName(): string {
		return 'administrationsystemconfigurationcontentcontrol'; 
	}
	...
	protected function getTemplate(): string {
		return 'ContentControl/AdministrationSystemConfigurationContentControl.php';
	}

	protected function fillView() {
		$content = 'Unable to load content.';
		$display = $this->classmap->getInstanceByInterfaceName(IDisplay::class, 'configurationadmindisplay');
		if ($display != null) {
