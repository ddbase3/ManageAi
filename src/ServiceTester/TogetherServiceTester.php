...
/**
 * Validates Together AI API key via minimal chat completion call.
 */
class TogetherServiceTester implements IAiServiceTester {
    ...
    public function test(array $config): array {
        ...
        if ($code>=200&&$code<300) return ['ok'=>true,'apikey_valid'=>true,'message'=>'Together AI OK'];
