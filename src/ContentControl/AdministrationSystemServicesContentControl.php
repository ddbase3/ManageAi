...
class AdministrationSystemServicesContentControl extends AbstractContentControl {
	...
	public static function getName(): string {
		return 'administrationsystemservicescontentcontrol'; 
	}
	...
	protected function getTemplate(): string {
		return 'ContentControl/AdministrationSystemServicesContentControl.php';
	}

	protected function fillView() {
		$content = 'Unable to load content.';
		$display = $this->classmap->getInstanceByInterfaceName(IDisplay::class, 'servicesadmindisplay');
		if ($display != null) {
