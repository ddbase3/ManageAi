...
class AdministrationLlmConfigContentControl extends AbstractContentControl {
	...
	public static function getName(): string {
		return 'administrationllmconfigcontentcontrol'; 
	}
	...
	protected function getTemplate(): string {
		return 'ContentControl/AdministrationLlmConfigContentControl.php';
	}

	protected function fillView() {
		$content = 'Unable to load content.';
		$display = $this->classmap->getInstanceByInterfaceName(IDisplay::class, 'llmconfigdisplay');
		if ($display != null) {
