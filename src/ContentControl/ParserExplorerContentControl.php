...
class ParserExplorerContentControl extends AbstractContentControl {
	...
	public static function getName(): string {
		return 'parserexplorercontentcontrol'; 
	}
	...
	protected function getTemplate(): string {
		return 'ContentControl/ParserExplorerContentControl.php';
	}

	protected function fillView() {
		$content = 'Unable to load content.';
		$display = $this->classmap->getInstanceByInterfaceName(IDisplay::class, 'parserexploreradmindisplay');
		if ($display != null) {
