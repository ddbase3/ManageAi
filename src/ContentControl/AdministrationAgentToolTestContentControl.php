...
class AdministrationAgentToolTestContentControl extends AbstractContentControl {
	...
	public static function getName(): string {
		return 'administrationagenttooltestcontentcontrol'; 
	}
	...
	protected function getTemplate(): string {
		return 'ContentControl/AdministrationAgentToolTestContentControl.php';
	}

	protected function fillView() {
		$content = 'Unable to load content.';
		$display = $this->classmap->getInstanceByInterfaceName(IDisplay::class, 'agenttooltestadmindisplay');
		if ($display != null) {
