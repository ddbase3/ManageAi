...
class AdministrationImageConfigContentControl extends AbstractContentControl {
	...
	public static function getName(): string {
		return 'administrationimageconfigcontentcontrol'; 
	}
	...
	protected function getTemplate(): string {
		return 'ContentControl/AdministrationImageConfigContentControl.php';
	}

	protected function fillView() {
		$content = 'Unable to load content.';
		$display = $this->classmap->getInstanceByInterfaceName(IDisplay::class, 'imageconfigdisplay');
		if ($display != null) {
