...
class AdministrationAgentToolKnowledgeContentControl extends AbstractContentControl {
	...
	public static function getName(): string {
		return 'administrationagenttoolknowledgecontentcontrol'; 
	}
	...
	protected function getTemplate(): string {
		return 'ContentControl/AdministrationAgentToolKnowledgeContentControl.php';
	}

	protected function fillView() {
		$content = 'Unable to load content.';
		$display = $this->classmap->getInstanceByInterfaceName(IDisplay::class, 'knowledgeagentmemoryadmindisplay');
		if ($display != null) {
