...
class AdministrationAgentComponentPresetContentControl extends AbstractContentControl {
	...
	public static function getName(): string {
		return 'administrationagentcomponentpresetcontentcontrol'; 
	}
	...
	protected function getTemplate(): string {
		return 'ContentControl/AdministrationAgentComponentPresetContentControl.php';
	}

	protected function fillView() {
		$content = 'Unable to load content.';
		$display = $this->classmap->getInstanceByInterfaceName(IDisplay::class, 'agentcomponentpresetadmindisplay');
		if ($display != null) {
