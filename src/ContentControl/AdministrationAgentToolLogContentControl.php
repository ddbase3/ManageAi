...
class AdministrationAgentToolLogContentControl extends AbstractContentControl {
	...
	public static function getName(): string {
		return 'administrationagenttoollogcontentcontrol'; 
	}
	...
	protected function getTemplate(): string {
		return 'ContentControl/AdministrationAgentToolLogContentControl.php';
	}

	protected function fillView() {
		$content = 'Unable to load content.';
		$display = $this->classmap->getInstanceByInterfaceName(IDisplay::class, 'agenttoollogadmindisplay');
		if ($display != null) {
