...
/**
 * Validates DeepSeek API key via minimal chat completion call.
 */
class DeepSeekServiceTester implements IAiServiceTester {
    ...
    public function test(array $config): array {
        ...
        $payload = json_encode([
            "model" => "deepseek-chat",  // günstigstes + garantiert vorhanden
            "messages" => [
