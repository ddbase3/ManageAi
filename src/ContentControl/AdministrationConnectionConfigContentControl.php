...
class AdministrationConnectionConfigContentControl extends AbstractContentControl {
	...
	public static function getName(): string {
		return 'administrationconnectionconfigcontentcontrol'; 
	}
	...
	protected function getTemplate(): string {
		return 'ContentControl/AdministrationConnectionConfigContentControl.php';
	}

	protected function fillView() {
		$content = 'Unable to load content.';
		$display = $this->classmap->getInstanceByInterfaceName(IDisplay::class, 'connectionconfigdisplay');
		if ($display != null) {
