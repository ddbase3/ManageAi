...
class AdministrationParserServiceConfigContentControl extends AbstractContentControl {
	...
	public static function getName(): string {
		return 'administrationparserserviceconfigcontentcontrol'; 
	}
	...
	protected function getTemplate(): string {
		return 'ContentControl/AdministrationParserServiceConfigContentControl.php';
	}

	protected function fillView() {
		$content = 'Unable to load content.';
		$display = $this->classmap->getInstanceByInterfaceName(IDisplay::class, 'parserserviceconfigdisplay');
		if ($display != null) {
