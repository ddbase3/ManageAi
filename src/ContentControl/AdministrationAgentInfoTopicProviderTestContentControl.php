...
class AdministrationAgentInfoTopicProviderTestContentControl extends AbstractContentControl {
	...
	public static function getName(): string {
		return 'administrationagentinfotopicprovidertestcontentcontrol';
	}
	...
	protected function getTemplate(): string {
		return 'ContentControl/AdministrationAgentInfoTopicProviderTestContentControl.php';
	}

	protected function fillView() {
		$content = 'Unable to load content.';
		$display = $this->classmap->getInstanceByInterfaceName(IDisplay::class, 'agentinfotopicprovidertestadmindisplay');
		if ($display != null) {
